...
// Remove defaultData mock blocks if present
...
const extraUI = `            </div>
          ...
          <div className="space-y-3 mt-6">
            <label className="block text-xs font-semibold text-[#a6a6a6] uppercase tracking-wider mb-2">Data Configuration</label>
...
content = content.replace(endTarget, extraUI);
